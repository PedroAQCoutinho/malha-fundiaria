...
SELECT a.gid, a.area, area_desmatamento, area_desmatamento/a.area parea, 
CASE 
	WHEN area_desmatamento/a.area > 1 THEN FALSE 
	WHEN area_desmatamento/a.area < 0.05 THEN FALSE 
	ELSE TRUE
