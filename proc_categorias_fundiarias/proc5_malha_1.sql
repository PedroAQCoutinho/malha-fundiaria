...
DROP TABLE malhav2.proc5_malha_v3;
CREATE TABLE malhav2.proc5_malha_v3 (
...
CREATE INDEX proc5_malha_v3_cd_grid_idx ON malhav2.proc5_malha_v3 USING btree (cd_grid);
CREATE INDEX proc5_malha_v3_geom_idx ON malhav2.proc5_malha_v3 USING gist (geom);
CREATE INDEX proc5_malha_v3_gid_idx ON malhav2.proc5_malha_v3 USING btree (gid);
