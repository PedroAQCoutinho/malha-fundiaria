...
CASE WHEN antropizada IS NOT NULL THEN antropizada ELSE 0 END antropizada,  
CASE WHEN antropizada/area > 1 THEN 1 WHEN antropizada/area IS NULL THEN 0 ELSE antropizada/area END  pantropizada, 
CASE WHEN nao_antropizada IS NOT NULL THEN nao_antropizada ELSE 0 END nao_antropizada,  
CASE WHEN nao_antropizada/area > 1 THEN 1 WHEN nao_antropizada/area IS NULL THEN 0 ELSE nao_antropizada/area END  pnao_antropizada, 
