...
DROP TABLE IF EXISTS irregularidadesv2.proc5_car_categoria_fundiaria;
CREATE TABLE irregularidadesv2.proc5_car_categoria_fundiaria (
...
CREATE INDEX proc5_car_categoria_fundiaria_car_idx ON irregularidadesv2.proc5_car_categoria_fundiaria USING btree (car);
CREATE INDEX proc5_car_categoria_fundiaria_nm_agrup_idx ON irregularidadesv2.proc5_car_categoria_fundiaria USING btree (nm_agrup);


DROP TABLE irregularidadesv2.temp_cat_fund;
...
CREATE INDEX temp_cat_fund_original_gid_idx ON irregularidadesv2.temp_cat_fund USING btree (original_gid);
CREATE INDEX temp_cat_fund_nm_agrup_idx ON irregularidadesv2.temp_cat_fund USING btree (nm_agrup);
CREATE INDEX temp_cat_fund_area_idx ON irregularidadesv2.temp_cat_fund USING btree (area);
