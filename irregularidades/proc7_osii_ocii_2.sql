...
\echo RUN :var_proc
INSERT INTO irregularidades.proc7_step14_categorizacao_1404 (car, tipo_imove,  area_imovel, am_legal, 
cd_mun, cd_bioma, nm_agrup, nm_cat_fund, m_fiscal, is_grande, is_recente, is_desm_recente, desmatamento, is_local_restrito, tipo_irregularidade, geom )
SELECT 
a.gid car, 
tipo_imove ,
a.area area_imovel, 
