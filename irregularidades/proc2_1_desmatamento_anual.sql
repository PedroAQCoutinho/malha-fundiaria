...
INSERT INTO irregularidades.proc21_malha_uso_anual (cat_fund, car, uso, area)
SELECT cat_fund, car, uso, sum(count)*0.087 area FROM irregularidades.proc1_malhav2 psar 
