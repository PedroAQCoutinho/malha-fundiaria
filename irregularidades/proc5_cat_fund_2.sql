...
INSERT INTO irregularidades.proc5_malha_categoria_fundiaria
SELECT a.gid , foo.nm_agrup, am_legal FROM dados_brutos.valid_sicar_imovel a 
LEFT JOIN LATERAL
(SELECT * FROM irregularidades.temp_cat_fund tcf WHERE tcf.original_gid = a.gid ORDER BY original_gid, area DESC LIMIT 1) foo ON TRUE 
